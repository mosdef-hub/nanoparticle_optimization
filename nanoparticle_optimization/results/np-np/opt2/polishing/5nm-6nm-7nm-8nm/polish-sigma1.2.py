...
for radius in radii:
    opt_path = os.path.join('results', 'np-np', 'opt2', 'brute',
...
epsilon = np_opt.Parameter(value=epsilon_val, upper=6.0, lower=0.5)
n = np_opt.Parameter(value=n_val, upper=50.0, lower=12.0)
m = np_opt.Parameter(value=m_val, upper=7.0, lower=4.0)
