...
resource_path = '/'.join(('utils', 'U_{}nm_MMM_truncated.txt'.format(int(radius))))
...
'''
------------------------------
Create Nanoparticle-MMM System
------------------------------
'''
...
epsilon = np_opt.Parameter(value=0.5, upper=1.5, lower=0.1)
